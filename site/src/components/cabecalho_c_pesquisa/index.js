...
function Cabecalho_com_pesquisa() {
    ...
    }, [charIndex, placeholderIndex, placeholders]); // Adicionado `placeholders` ao array de dependências

    return (
        <main className="cabecalho_com_pesquisa">
...
export default Cabecalho_com_pesquisa;
